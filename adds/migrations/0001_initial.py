# Generated by Django 4.0.7 on 2022-09-20 09:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choice', models.CharField(choices=[('VIP', 'VIP'), ('urgent', 'срочно'), ('highlight', 'выделить')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice', models.CharField(blank=True, choices=[('wrong', 'Неверная рубрика'), ('forbidden', 'Запрещенный товар'), ('not_relevant', 'Объявление не актуально'), ('wrong_address', 'Неверный адрес'), ('other', 'Другое'), ('', '')], default=('', ''), max_length=100, null=True)),

# Generated by Django 4.0.7 on 2022-09-21 10:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('in_progress', 'в рассмотрении'), ('verified', 'одобрено'), ('rejected', 'отклонено')], default='in_progress', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choice', models.CharField(choices=[('VIP', 'VIP'), ('urgent', 'Добавить стикер "Срочно"'), ('highlight', 'Выделить цветом')], max_length=100)),
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=20)),
                ('text', models.CharField(max_length=100)),
                ('icon_image', models.ImageField(upload_to='')),
                ('outer_image', models.ImageField(upload_to='')),
                ('period', models.CharField(choices=[('5 days', '5'), ('10 days', '10'), ('15 days', '15'), ('20 days', '20'), ('25 days', '25'), ('30 days', '30')], max_length=100)),
            ],
            options={
                'ordering': ['-id'],
            },
